...
public class ModuleController {
    ...
    public ResponseEntity<Object> saveModule(@PathVariable(value="courseId")UUID courseId,
        ...
        BeanUtils.copyProperties(moduleDto, moduleModel); //faz a conversao de dto p model
        moduleModel.setCreationDate(LocalDateTime.now(ZoneId.of("UTC")));
        moduleModel.setCourse(courseModelOptional.get()); //relacionamento entre curso e módulo
    ...
    public ResponseEntity<Object> getOneModule(@PathVariable(value="courseId")UUID courseId,
        ...
        return moduleModelOptional.<ResponseEntity<Object>>map(moduleModel -> ResponseEntity.status(HttpStatus.OK)
                .body(moduleModel)).orElseGet(() -> ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body("Module Not Found for this Course"));
